  ...
  return (
    <div className="modal-overlay" onClick={onCancel}>
      <div className="modal-box modal-sm" onClick={e => e.stopPropagation()}>
        ...
        <p className="modal-title" style={{ textAlign: "center" }}>Supprimer l'agent ?</p>
        <p className="modal-sub" style={{ textAlign: "center" }}>
          Le compte de <strong>{agent.prenom} {agent.nom}</strong> sera définitivement supprimé.
          Ses actions passées sur la plateforme seront conservées.
        </p>
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-box" onClick={e => e.stopPropagation()}>
        ...
        <p className="modal-sub">
          À : <strong>{agent.prenom} {agent.nom}</strong> — {agent.email}
        </p>
