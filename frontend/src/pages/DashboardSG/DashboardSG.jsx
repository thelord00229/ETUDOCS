...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sidebar-logo { padding: 28px 20px 28px; }
  .logo-text { font-size: 22px; font-weight: 700; color: white; letter-spacing: -0.5px; }
  .logo-text span { color: var(--accent-gold); font-weight: 400; font-size: 14px; margin-left: 6px; letter-spacing: 0.5px; }
  ...
  .notif-btn { position: relative; background: none; border: none; cursor: pointer; padding: 4px; color: var(--text-muted); font-size: 22px; display: flex; align-items: center; }
  ...
  .page-subtitle { font-size: 14px; color: var(--text-muted); margin-top: 6px; font-weight: 400; }
  ...
  .actualiser-btn:disabled { opacity: 0.6; cursor: not-allowed; transform: none; box-shadow: none; }
  ...
  .stat-icon {
    ...
    font-size: 24px; flex-shrink: 0; border: 2px solid;
  }
  ...
  .badge-count { background: #7c3aed; color: white; font-size: 11px; font-weight: 700; padding: 2px 9px; border-radius: 20px; min-width: 22px; text-align: center; }
  ...
  .table-divider { height: 1px; background: var(--border); margin: 0; }
  ...
  .empty-state { padding: 80px 24px; text-align: center; background: var(--bg); margin: 0; }
...
export default function DashboardSG() {
  ...
  // ✅ WORKFLOW: TRANSMETTRE au Chef de Division
        ...
        <main className="main">
          ...
          <header className="topbar">
            ...
            <div className="topbar-right">
              ...
              <div className="user-info">
                <div className="user-name">Secrétaire Général</div>
          ...
          <div className="content">
            <div className="page-header">
              <div>
                <h1 className="page-title">Espace Secrétaire Général</h1>
                <p className="page-subtitle">Transmission des demandes au Chef de Division</p>
              </div>
            ...
            <div className="stats-grid">
              <div className="stat-card">
                ...
                <div>
                  <div className="stat-value">{String(aTransmettre)}</div>
                  <div className="stat-label">À transmettre</div>
                </div>
              </div>
              ...
              <div className="stat-card">
                ...
                <div>
                  ...
                  <div className="stat-label">Transmis (mois)</div>
                </div>
              </div>
              ...
              <div className="table-wrapper">
                <table>
                  ...
                  <tbody>
                    {filtered.map((d) => {
                      ...
                      return (
                        <tr key={d.id || ref}>
                          <td><span className="mono">{ref}</span></td>
                          <td>
                            <div style={{ fontWeight: 800 }}>{etu}</div>
                            <div className="muted">N° {num}</div>
                          </td>
                          <td>{type}</td>
                          <td className="muted">{created}</td>
                          <td><span className="chip">{statut}</span></td>
                          <td style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
                            <button className="btn outline" onClick={() => openPreview(d)} disabled={busyId === d.id}>
                              👁 Consulter
                            </button>
                ...
                {filtered.length === 0 && (
                  <div className="empty-state">
                    ...
                    <div className="empty-text">Aucune demande à transmettre</div>
                  </div>
                )}
              </div>
            </div>
